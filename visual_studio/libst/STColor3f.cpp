...
STColor3f STColor3f::operator+(float rhs) const {
    STColor3f rval;
    rval.r = this->r + rhs;
    rval.g = this->g + rhs;
    rval.b = this->b + rhs;
...
STColor3f& STColor3f::operator+=(float rhs) {
    this->r += rhs;
    this->b += rhs;
    this->g += rhs;
    return *this;
...
{
    return STColor3f(lhs*rhs.r, lhs*rhs.g, lhs*rhs.b);
    // just flip it around
    //return rhs * lhs;
}

float STColor3f::maxComponent() const {
