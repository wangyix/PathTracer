...
public:
    ...
    ~AmbientLight(){}
    STColor3f color(Intersection *inter, const STVector3& view, const STColor3f& amb, const STColor3f& diff, const STColor3f& spec, float shine) override { return col * amb; }
